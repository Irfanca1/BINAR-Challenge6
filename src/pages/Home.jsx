    ...
    <>
      <Container className="mt-3">
        ...
        <section id="home">
          <Row>
            <Col md="6" className="sewa mt-5 text-start">
              ...
              <Nav.Link as={Link} to="/cars" className="text-light fw-bold btn btn-success w-50">
                Mulai sewa mobil
              </Nav.Link>
            </Col>
            <Col md="6 mt-5">
            ...
            <Col md="6" className="our-service-content mt-5">
              <div className="binar-sewa-mobil text-start">
                ...
                <p className="ms-4 sewa-mobil">
                  Sewa mobil di (Lokasimu) bersama Binar Car Rental jaminan harga lebih murah <br /> dibandingkan yang lain, kondisi mobil baru, serta kualitas pelayanan terbaik untuk <br /> perjalanan wisata, bisnis, wedding, meeting, dll.
                </p>
                <ul>
          ...
          <Row>
            <Col md="2" className="ms-5" style={{ margin: '0 5rem' }}>
              <Card className="rounded shadow-sm" style={{ width: '16.5rem' }}>
                ...
                <Card.Body>
                  <Card.Title className="fw-bold mb-4 text-start">
                    <h5>Mobil Lengkap</h5>
                  </Card.Title>
        ...
        <section id="testimonial">
          ...
          <Row className="row-testimonial">
            <Col md="4" style={{ position: 'relative', left: '-16rem' }}>
              <div style={{ width: '35rem', background: '#F1F3FF' }}>
                <OwlCarousel className="owl-theme" autoplay nav dots>
                  <div className="item">
                    <Row className="card-testimonial">
                      <Col md="3">
                        <img src="/assets/images/img_photo2.png" className="ms-2 mt-5 img-testimonial" alt="Gambar" />
                      </Col>
                      <Col md="9" className="p-4">
                        <div className="rate">
                          <img src="/assets/images/Rate.png" className="ms-5" alt="Rate" />
                        </div>
                        <p className="text-start ms-5" style={{ width: '29rem' }}>
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem nobis quasi tenetur qui sed illum magnam repudiandae blanditiis nesciunt.
                        </p>
                        <p>
                          <div className="fw-bold text-start ms-5" style={{ width: '29rem' }}>
                            John Dee 32, Bromo
                          </div>
                        </p>
                      </Col>
            ...
            <Col md="4" style={{ position: 'relative', left: '-8rem' }}>
              <div style={{ width: '35rem', background: '#F1F3FF' }}>
                <OwlCarousel className="owl-theme" autoplay nav dots>
                  <div className="item">
                    <Row className="card-testimonial">
                      <Col md="3">
                        <img src="/assets/images/img_photo.png" className="ms-2 mt-5 img-testimonial" alt="Gambar" />
                      </Col>
                      <Col md="9" className="p-4">
                        <div className="rate">
                          <img src="/assets/images/Rate.png" className="ms-5" alt="Rate" />
            ...
            <Card>
              <Card.Body>
                <Card.Title>
                  ...
                  <a href="/cars" className="btn btn-success mt-5 fw-bold">
                    Mulai Sewa Mobil
                  </a>
                </Card.Title>
              </Card.Body>
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                      <div className="accordion-body">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore magnam, voluptatum eos voluptatibus exercitationem obcaecati quibusdam ad quia! Commodi numquam porro, aliquid id quibusdam a fugit maiores voluptas
